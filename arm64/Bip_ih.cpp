...
#define Dn _ml->template fpfield<3>(_iml)
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"Dn"} /* 3 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 ih /Users/cynthiawang/417_project/Publio-et-al-2009/NEURON/Bip_ih.mod\n");
 ...
 v=_v;
{
 { error =  states();
 if(error){
  std_cerr_stream << "at line 37 in file Bip_ih.mod:\nBREAKPOINT {\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/cynthiawang/417_project/Publio-et-al-2009/NEURON/Bip_ih.mod";
